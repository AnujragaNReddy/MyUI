...
export default function ColorOptionsList() {
  ...
  const isBg = selectedTool === "backgroundColors";
  const isFg = selectedTool === "foregroundColors";
  return (
    <>
      <input
      ...
      <div className="quotes-options-grid">
        {filteredColors.map((color) => (
          <div
            ...
            onClick={() => {
              if (isBg) updateCanvas({ backgroundColor: color });
              if (isFg) updateCanvas({ textColor: color });
            }}
          >
            <div
              style={{
